...
device.</alert>
<alert type="info">This is **not** a guide to install a **Modded OS**. Please read the next article from this for more
information on that.</alert>

<iframe width="560" height="315" src="https://www.youtube.com/embed/Oon90CvoIUM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
* Here comes the **GUI Selection**
  ...
  <alert type="info">Graphical User Interface or GUI is the visual interface that you interact with to do things in your
  Linux distribution.</alert>
* You now have the option to choose among the three following options:
    1. **Desktop Environment**: You can choose a Desktop Environment if you would like to use your mouse as well as your
       keyboard, or you've little or no experience with Linux. More
       information [here](../desktop-environments/desktop-environments.md).
    2. **Window Manager**: You can choose a Window Manager if you only want to use your keyboard to manage Windows and
    ...
    3. **Command Line Interface (CLI)**: If you don't want a Graphical User-interface, you can go ahead with the **
       Command Line Interface**. You'll have a terminal, which is enough if you know what you're doing in your session.
...
* Based on your selection above, please follow the respective instructions below:
  ...
  Since you've chosen the Command Line Interface, there's no extra configuration required on your part. You may proceed
...
* The installation/downloading will take some time. Please leave the Termux app running.
  ...
  <alert type="info">If the installation appears to be stuck on a certain step for an unusual time, please press the **
  Enter** key to resume the execution.</alert>
...
<alert type="info">If you are already in the distro shell i.e. you see `root@localhost` mentioned on Termux. **Please
skip the next section.**</alert>
